...
<div class="form-group {{ $errors->has('last_name') ? ' has-error' : '' }}">
    ...
    <div class="col-md-10">
        {!!Form::text('last_name','',['class' => 'form-control','id'=>'last_name','placeholder'=>'Apellido'])!!} @if ($errors->has('last_name'))
        <span class="help-block">
...
<div class="form-group {{ $errors->has('dni') ? ' has-error' : '' }}">
    ...
    <div class="col-md-10">
        {!!Form::text('dni','',['class' => 'form-control','id'=>'dni','placeholder'=>'dni'])!!} @if ($errors->has('dni'))
        <span class="help-block">
...
<div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
    ...
    <div class="col-md-10">
        {!!Form::email('email','',['class' => 'form-control','id'=>'email','placeholder'=>'Email'])!!} @if ($errors->has('email'))
        <span class="help-block">
...
<div class="form-group {{ $errors->has('sex') ? ' has-error' : '' }}">
    ...
    <div class="col-md-10">
        <div class="radio">
            <label for="sex">
                {!!Form::radio('sex', 'male', false,['for'=>'sex'])!!} Masculino
            </label>
        </div>
        <div class="radio">
            <label>
                {!!Form::radio('sex', 'female', false,['for'=>'sex'])!!} Femenino
            </label>
        </div>
        @if ($errors->has('sex'))
        <span class="help-block">
